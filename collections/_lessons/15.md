...
<small>
    (Zde je zapotřebí upozornit na <a href="https://cs.wikipedia.org/wiki/Kr%C3%A1tk%C3%A1_a_dlouh%C3%A1_%C5%A1k%C3%A1la">různé systémy v pojmenování 
    vysokých čísel</a>. Oproti anglickému originálu je výše použita tzv. dlouhá škála - pozn. překladatele)
</small>    
